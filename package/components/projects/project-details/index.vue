...
// Local smooth scroll helper so 'Back' goes to the projects section on the single page
...
<template>
  ...
  <div class="bg-darkgray">
    <SharedSectionSpacer />
    <div class="container-lg">
      <v-btn class="interactive-button-small" size="lg" flat @click.prevent="scrollTo('#projects')">
